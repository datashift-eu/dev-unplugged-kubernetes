...
def main() -> None:
    ...
    endpoint        = args.endpoint        or get_env("MINIO_ENDPOINT",    required=True)
    access_key      = args.access_key      or get_env("MINIO_ACCESS_KEY",  required=True)
    secret_key      = args.secret_key      or get_env("MINIO_SECRET_KEY",  required=True)
